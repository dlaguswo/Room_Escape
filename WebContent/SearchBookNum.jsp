...
예약 번호 찾기
 ...
 -->
	<title>Search Reserv Number</title>
	<meta charset="UTF-8">
...
function sendIt() {
	...
	f.action = "<%=cp%>/escb/searchBookNum_ok.do";
	f.submit();
			...
			<div class="wrap-login100 p-t-50 p-b-90">
				<form class="login100-form validate-form flex-sb flex-w" name="myForm" method="post" onsubmit="return false;">
					...
					<div class="container-login100-form-btn m-t-17">
						...
						<button class="login100-form-btn-left checkfont" onclick="javascript:location.href='<%=cp%>/escb/book.do';">
							뒤로가기
						</button>
					</div>
