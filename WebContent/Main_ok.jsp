...
<!--  ㅇㅣㅁㅣ지 -->
	<section class="bg-dark-30 showcase-page-header module parallax-bg" data-background="<%=cp%>/data/img/greatescape.gif">
		<div class="titan-caption">
			<div class="caption-content">
				<div class="font-alt mb-30 titan-title-size-1">&nbsp;</div>
				<div class="font-alt mb-40 titan-title-size-4">&nbsp;</div>
			</div>
		</div>
	</section>
...
<!--  메인문 테마 -->
  	<c:if test="${!empty listsT }">
	<form action="" method="post">
      <div class="main showcase-page">
		<!--  메인 내용 -->
			<div class="container">
				<div class="row multi-columns-row">
					<c:forEach var="dto" items="${listsT }"  step="1">
